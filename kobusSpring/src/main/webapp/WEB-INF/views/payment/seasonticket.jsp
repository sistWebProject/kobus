		...
		<div class="container">
			<form name="passPrchFrm" id="passPrchFrm" method="post">
				...
				<input type="hidden" id="adtnDeprTrmlNo" name="adtnDeprTrmlNo"
					...
					type="hidden" id="adtnDeprNm" name="adtnDeprNm" value=""> <input
					type="hidden" id="adtnArvlNm" name="adtnArvlNm" value=""> <input
					type="hidden" id="adtnPrdUseClsNm" name="adtnPrdUseClsNm" value="">
				<input type="hidden" id="adtnPrdUseNtknNm" name="adtnPrdUseNtknNm"
					value=""> <input type="hidden" id="wkdWkeNtknNm"
					name="wkdWkeNtknNm" value=""> <input type="hidden"
					id="timSttDte" name="timSttDte" value=""> <input
					type="hidden" id="timEndDte" name="timEndDte" value=""> <input
					type="hidden" id="prchAmt" name="prchAmt" value=""> <input
					type="hidden" name="goodsPrice" id="goodsPrice" value=""> <input
					type="hidden" id="adtnPrdUseClsCd" name="adtnPrdUseClsCd" value="">
				<input type="hidden" id="adtnPrdUseNtknCd" name="adtnPrdUseNtknCd"
					value=""> <input type="hidden" id="wkdWkeNtknCd"
					name="wkdWkeNtknCd" value=""> <input type="hidden"
					id="adtnPrdUsePsbDno" name="adtnPrdUsePsbDno" value=""> <input
					type="hidden" id="adtnPrdSno" name="adtnPrdSno"
					value="${adtnPrdSno}"> <input type="hidden" name="pymType"
								...
								<dd>
									<div class="boxinput_wrap col2 clfix">
										<div class="box_inputForm desc_wrap">
											...
											<p class="desc" id="tmpPsbYN" style="display: none;">※ 해당
												옵션은 임시차 배차도 사용 가능합니다.</p>
											<!-- 190319 추가 -->
										</div>
										<!-- 190319 추가 -->
