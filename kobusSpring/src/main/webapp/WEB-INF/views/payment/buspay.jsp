...
<article id="new-kor-content">
	...
	<form name="stplCfmPymFrm" id="stplCfmPymFrm" method="post"
		...
		<input type="hidden" name="indVBusClsCd" id="indVBusClsCd"
			value="${indVBusClsCd}">
		<!-- 버스등급 -->
		<input type="hidden" name="takeDrtmOrg" id="takeDrtmOrg"
			value="${takeDrtmOrg}">
		<!-- 소요시간 -->
		<input type="hidden" name="distOrg" id="distOrg" value="208.3">
		<!-- 거리 -->
		<input type="hidden" name="rtrpChc" id="rtrpChc" value="1">
		<!-- 왕편 복편 설정 -->
		<!-- 출발일자:deprDtm or arvlDtm, 출발터미널번호:deprCd, 도착터미널번호:arvlCd  -->
		<input type="hidden" name="deprDt" id="deprDt" value="${deprDt}">
		<!-- 출발일 -->
		...
		<input type="hidden" name="selSeatNum" id="selSeatNum"
			value="${selSeatNum}">
		<!-- 선택좌석번호 -->
		<input type="hidden" name="selSeatCnt" id="selSeatCnt"
			value="${selSeatCnt}">
		<!-- 선택좌석수 -->
		<input type="hidden" name="selAdltCnt" id="selAdltCnt"
			value="${selAdltCnt}">
		<!-- 어른수 -->
		<input type="hidden" name="selAdltDcCnt" id="selAdltDcCnt" value="0">
		<!-- 할인대상어른수 -->
		<input type="hidden" name="selChldCnt" id="selChldCnt"
			value="${selChldCnt}">
		<!-- 초등생수 -->
		<input type="hidden" name="selTeenCnt" id="selTeenCnt"
			value="${selTeenCnt}">
		<!-- 중고생수 -->
		...
		<!-- 비회원여부 Y:비회원, N:회원 -->
		<input type="hidden" name="pymType" id="pymType" value="card">
		<!-- 결제타입 card:카드,acnt:계좌이체, famt:정액권,perd:정기권,milage:마일리지   -->
		...
		<!-- 모바일발권여부   -->
		<input type="hidden" name="mblUtlzPsbYnOrg" id="mblUtlzPsbYnOrg"
			value="Y">
		<!-- 모바일발권여부   -->
		<input type="hidden" name="tlcnTrcnUtlzPsbYn" id="tlcnTrcnUtlzPsbYn"
			value="Y">
		<!-- 통합단말기유무   -->
		<input type="hidden" name="allCardNum" id="allCardNum" value="">
		<!-- cardnum   -->
		<input type="hidden" name="userDvsCd" id="userDvsCd" value="1">
		<!-- 사용자구분 1:개인 , 2:법인, 3:외국인   -->
		<input type="hidden" name="satsNoAll" id="satsNoAll"
			value="${selSeatNum}">
		<!-- 선택좌석번호전체   -->
		<input type="hidden" name="pcpyNoAll" id="pcpyNoAll"
			value="20250606956740">
		<!-- 선점번호전체   -->
		...
		<!-- 20201124 yahan -->
		<input type="hidden" name="chitUseDvs" id="chitUseDvs" value="0">
		<!-- 소득공제구분 0:소비자, 1:사업자, 2:자진발급-->

		<!-- 계좌이체 후 데이터 -->
		<input type="hidden" name="csrcNo" id="csrcNo" value="">
		<!-- 현금영수증번호(HP or CARD)   -->

		<!-- 부가상품 발권 데이터 -->
		<input type="hidden" name="adtnPrdPayType" id="adtnPrdPayType"
			value="">
		<!-- 부가상품 구분  -->
		<input type="hidden" name="adtnPrdVldCnt" id="adtnPrdVldCnt" value="0">
		<!-- 유효한 부가상품 데이터 수  -->
		<input type="hidden" name="adtnPrdErrYn" id="adtnPrdErrYn" value="Y">
		<!-- 부가상품 사용가능여부 N:불가, Y:가능  -->
		<input type="hidden" name="adtnPrdInpYn" id="adtnPrdInpYn" value="Y">
		<!-- 부가상품 데이터 직접입력여부 Y:직접입력, N:SELECT BOX  -->
		<input type="hidden" name="adtnPrdDvsCd" id="adtnPrdDvsCd" value="">
		<!-- 부가상품 종류코드: 정액권, 정기권 확인필요   -->
		<input type="hidden" name="adtnPrdBirth" id="adtnPrdBirth" value="">
		<!-- 부가상품 생년월일   -->
		<input type="hidden" name="adtnPrdPubChtkSno" id="adtnPrdPubChtkSno"
			value="">
		<!-- 부가상품일련번호   -->
		<input type="hidden" name="adtnPrdAutho" id="adtnPrdAutho" value="">
		<!-- 부가상품 인증번호   -->
		<input type="hidden" name="adtnPrdVldChkYn" id="adtnPrdVldChkYn"
			value="N">
		<!-- 부가상품 유효성검증여부   -->

		<input type="hidden" name="adtnCpnNo" id="adtnCpnNo" value="">
		<!-- 부가상품일련번호   -->
		<input type="hidden" name="passCnt" id="passCnt" value="0">
		<!-- 사용가능한 정기권 갯수 -->
		<input type="hidden" name="frpsCnt" id="frpsCnt" value="0">
		<!-- 사용가능한 프리패스 갯수 -->
		<input type="hidden" name="tckKndCd" id="tckKndCd" value="">
		<!-- 부가상품 권종 -->

		<input type="hidden" name="mileagePymYn" id="mileagePymYn" value="N">
		<!-- 마일리지결제가능여부 Y:가능, N:불가능   -->

		<input type="hidden" name="webScrnRnwl" id="webScrnRnwl" value="Y">
		<!-- 화면갱신을 위한 데이터 Y:새로고침, N:신규   -->

		<input type="hidden" name="unmnTerYn" id="unmnTerYn" value="N">
		<!-- 무인터미널여부 Y:무인, N:유인   -->
		<input type="hidden" name="rtrpYn" id="rtrpYn" value="N">
		<!-- 왕복여부 계좌이체 불가 안내문구용, Y:왕복,N:편도   -->

		<input type="hidden" name="tissuFn" id="tissuFn" value="N">
		<!-- 발권완료여부   -->
		<input type="hidden" name="tissuFnAllData" id="tissuFnAllData"
			value="">
		<!-- 발권완료여부   -->

		<!-- 	2020-01-12 yahan 모바일티켓 오류수정 -->

		<input type="hidden" name="mblTissuYn" id="mblTissuYn" value="Y">
		<!-- 모바일발권여부   -->

		<input type="hidden" name="agrmYn" id="agrmYn" value="U">
		<!-- 국민차장제 동의 여부(Y:동의, N:거부, U:미대상)  -->

		<input type="hidden" name="RSAModulus" id="RSAModulus"
			value="">
		<!-- 카드번호 암호화시 사용 -->
		...
		<!-- 거래처코드 -->
		<input type="hidden" name="DPC_NO" id="DPC_NO" value=""> <input
			type="hidden" name="track2Data" id="track2Data" value="">
		<!-- 간편결제 -->
		<input type="hidden" name="authInf" id="authInf" value="">
		<!-- 간편결제 -->
		<input type="hidden" name="oderNo" id="oderNo" value="">
		<!-- 간편결제 -->
		<input type="hidden" name="trdNo" id="trdNo" value="">
		<!-- 간편결제 -->


		<!-- 발권 완료후 폼전송을 위한 데이터 -->
		<input type="hidden" name="tissuFnfailYn" id="tissuFnfailYn" value="">
		<input type="hidden" name="tissuFnrtnMsgNm" id="tissuFnrtnMsgNm"
			value=""> <input type="hidden" name="tissuFnrtnDtlMsgNm"
			id="tissuFnrtnDtlMsgNm" value=""> <input type="hidden"
			name="tissuFndeprDtDtl1" id="tissuFndeprDtDtl1" value=""> <input
			type="hidden" name="tissuFndeprTimeDtl1" id="tissuFndeprTimeDtl1"
			value=""> <input type="hidden" name="tissuFnmrsMrnpNo1"
			id="tissuFnmrsMrnpNo1" value=""> <input type="hidden"
			name="tissuFndeprTrmlNm1" id="tissuFndeprTrmlNm1" value=""> <input
			type="hidden" name="tissuFnarvlTrmlNm1" id="tissuFnarvlTrmlNm1"
			value=""> <input type="hidden" name="tissuFntakeDrtm1"
			id="tissuFntakeDrtm1" value=""> <input type="hidden"
			name="tissuFncacmNm1" id="tissuFncacmNm1" value=""> <input
			type="hidden" name="tissuFncacmCss1" id="tissuFncacmCss1" value="">
		<input type="hidden" name="tissuFnbusClsNm1" id="tissuFnbusClsNm1"
			value=""> <input type="hidden" name="tissuFnrotRdhmNo1"
			id="tissuFnrotRdhmNo1" value=""> <input type="hidden"
			name="tissuFnmrsNumAll1" id="tissuFnmrsNumAll1" value=""> <input
			type="hidden" name="tissuFnsatsNo1" id="tissuFnsatsNo1" value="">
		<input type="hidden" name="tissuFndeprDtDtl2" id="tissuFndeprDtDtl2"
			value=""> <input type="hidden" name="tissuFndeprTimeDtl2"
			id="tissuFndeprTimeDtl2" value=""> <input type="hidden"
			name="tissuFnmrsMrnpNo2" id="tissuFnmrsMrnpNo2" value=""> <input
			type="hidden" name="tissuFndeprTrmlNm2" id="tissuFndeprTrmlNm2"
			value=""> <input type="hidden" name="tissuFnarvlTrmlNm2"
			id="tissuFnarvlTrmlNm2" value=""> <input type="hidden"
			name="tissuFntakeDrtm2" id="tissuFntakeDrtm2" value=""> <input
			type="hidden" name="tissuFncacmNm2" id="tissuFncacmNm2" value="">
		<input type="hidden" name="tissuFncacmCss2" id="tissuFncacmCss2"
			value=""> <input type="hidden" name="tissuFnbusClsNm2"
			id="tissuFnbusClsNm2" value=""> <input type="hidden"
			name="tissuFnrotRdhmNo2" id="tissuFnrotRdhmNo2" value=""> <input
			type="hidden" name="tissuFnmrsNumAll2" id="tissuFnmrsNumAll2"
			value=""> <input type="hidden" name="tissuFnsatsNo2"
			id="tissuFnsatsNo2" value=""> <input type="hidden"
			name="tissuFnpymCfmTime" id="tissuFnpymCfmTime" value=""> <input
			type="hidden" name="tissuFnpymType" id="tissuFnpymType" value="">
		<input type="hidden" name="tissuFnpynDtlCd" id="tissuFnpynDtlCd"
			value=""> <input type="hidden" name="tissuFnmblUtlzPsbYn"
			id="tissuFnmblUtlzPsbYn" value=""> <input type="hidden"
			name="tissuFnpsrmCls" id="tissuFnpsrmCls" value=""> <input
			type="hidden" name="tissuFnestmAmt" id="tissuFnestmAmt" value="">
		<input type="hidden" name="tissuFndcAmt" id="tissuFndcAmt" value="">
		<input type="hidden" name="tissuFntissuAmt" id="tissuFntissuAmt"
			value=""> <input type="hidden" name="tissuFnacmtMlg"
			id="tissuFnacmtMlg" value=""> <input type="hidden"
			name="tissuFnmrsMrnpNoOrg" id="tissuFnmrsMrnpNoOrg" value="">
		<input type="hidden" name="tissuFnrecNcnt1" id="tissuFnrecNcnt1"
			value=""> <input type="hidden"
			name="tissuFntlcnTrcnUtlzPsbYn" id="tissuFntlcnTrcnUtlzPsbYn"
			value=""> <input type="hidden" name="tissuHtckPsbYn"
			id="tissuHtckPsbYn" value="">

		<div class="loading" id="loading"
			style="height: 2410px; top: 180px; display: none;">
		...
		<div class="content-header"
			data-page-title="결제정보입력 | 고속버스예매 | 고속버스예매 | 고속버스통합예매">
			<div class="container">
			...
			<div class="container">
				...
				<div class="section">
					<div class="agreement_wrap">
						...
						<span class="custom_check chk_blue"> <input type="checkbox"
							id="agree1" onclick="fnChgCfmBtn();"> <label for="agree1">동의</label>
						</span>
					</div>
					<div class="agreement_wrap">
						<div class="agreement_tit">
						...
						<span class="custom_check chk_blue"> <input type="checkbox"
							id="agree2" onclick="fnChgCfmBtn();"> <label for="agree2">동의</label>
						</span>
					</div>
					<div class="agreement_wrap">
						<div class="agreement_tit">
						...
						<span class="custom_check chk_blue"> <input type="checkbox"
							id="agree3" onclick="fnChgCfmBtn();"> <label for="agree3">동의</label>
						</span>
					</div>
					...
					<div class="agreement_wrap">
						...
						<span class="custom_check chk_blue"> <input type="checkbox"
							id="agree4" onclick="fnChgCfmBtn();"> <label for="agree4">동의</label>
						</span>
					</div>
				...
				<div class="section" id="unmnTerView" style="display: none;">
					<div class="ticketing_noti noti_box">
						<p>
							선택하신 노선은 출발지가 무인 터미널입니다.<br>교통카드 기능이 있는 신용카드 결제만 가능하며 예매 완료
							후 홈티켓 출력이 불가합니다.<br> 모바일 티켓 발권 또는 일반 예매 후 차량에 설치된 통합단말기에서
							발권하시기 바랍니다. <span style="color: #ff0000">※ 예매 시 사용한 신용카드를
								소지하지 않을 경우 통합단말기 발권이 불가합니다.</span>
						</p>
				...
				<div class="section" id="rtrpTckYn" style="display: none;">
					<div class="ticketing_noti noti_box">
						<p>
							왕복 승차권 예매 시 카드 결제만 가능하며 계좌이체 기능이 지원되지 않습니다.<br> 편도 승차권의 경우에도
							일부 노선은 계좌 이체가 지원되지 않으니 계좌이체가 확인 되지 않는 경우 카드 결제를 이용해 주시기 <br>바랍니다.
						</p>
				...
				<div class="section" id="IEChcView" style="display: none;">
					<div class="ticketing_noti noti_box">
						<p>
							접속하신 브라우저 환경에서는 계좌이체 기능이 지원되지 않습니다.<br> 계좌이체를 이용하시려면
							Internet Explorer 브라우저로 접속하시기 바랍니다.
						</p>
				...
				<div class="section" id="noMobileTck" style="display: none;">
					<div class="ticketing_noti noti_box">
						<p>
							예매하시려는 노선은 모바일 티켓 발권이 불가합니다.<br> 일반티켓으로 예매 후 홈티켓 발행 혹은
							출발터미널에서 발권하시기 바랍니다.
						</p>
				...
				<div id="mblTckYn" style="display: block;">
					...
					<p class="ticket_chk mo_page">
						...
						<span class="custom_radio active" id="moTicketSpan"> <input
							type="radio" id="moTicket" name="ticket" checked="checked"
							onclick="fnMblTck(&#39;CAN&#39;);"> <label for="moTicket">모바일
								티켓 발권</label>
						</span> <span class="custom_radio" id="nomoTicketSpan"> <input
							type="radio" id="nomalTicket" name="ticket"
							onclick="fnMoticketYn();" aria-expanded="false"> <label
							for="nomalTicket">일반 티켓 발권(홈티켓)</label>
						</span>
					...
					<div class="app_info" id="mobileAppGd" style="display: block;">
						<p class="noti">
							고속버스 티머니 설치하시고 <span class="line_block">빠르고 편리한 모바일 티켓
								이용하세요.</span>
						</p>
						<p class="txt">홈페이지에서 모바일 티켓 발권 시 기존과 동일하게 창구, 무인기에서 예매한 카드로
							발권이 가능합니다. 추가로 고속버스모바일 내 모바일티켓을 통해서도 별도 발권 절차 없이 승차가 가능합니다.</p>
						<p class="tip">
							<!-- 아직 앱이 없으시다면 아래 버튼을 클릭하세요. <br> -->
							고속버스 모바일앱 설치
						</p>
						<!-- 1103 -->
					</div>
				...
				<!-- //170206 수정-->
				<!-- <p class="bul" id="mobileAppInf" style="display:block;">모바일 티켓으로 예매하시면 홈페이지에서 예매 후 별도 발권절차 없이 <span class="txt_puple">고속버스 모바일앱을 통해서만 승차</span>가 가능합니다.</p> -->
				<p class="bul" id="mobileAppInf" style="display: block;">홈페이지에서
					모바일 티켓 발권 시 기존과 동일하게 창구, 무인기에서 예매한 카드로 발권이 가능합니다. 추가로 고속버스 티머니 내
					모바일티켓을 통해서도 별도 발권 절차 없이 승차가 가능합니다.</p>
				<!-- 20170603 추가 -->
							...
							<div class="tbl_type2">
								<table class="tbl_info">
									...
									<tbody>
										<tr>
											<th scope="row">고속사</th>
											<td><span>${cacmNm}</span> <!-- 동양고속 class="dyexpress" 삼화고속 class="samhwa" 중앙고속 class="jabus" 금호고속 class="kumho" 천일고속 class="chunil" 한일고속 class="hanil" 동부고속 class="dongbu" 금호속리산고속 class="songnisan" 코버스 class="kobus" -->
											</td>
										</tr>
										<tr>
											<th scope="row">등급</th>
										...
										<tr>
											<th scope="row">매수</th>
											<td><span id="totSelCntView">일반 ${selAdltCnt}명,
													중고생 ${selTeenCnt}명, 초등생 ${selChldCnt}명</span></td>
										</tr>
										<tr>
											<th scope="row">좌석</th>
											<td>${seatNos}번</td>
					...
					<div class="tab_wrap inradio tab_type2" data-desc-id="tab-desc1">
						...
						<div class="tab_conts" id="tab1" style="display: block;">
							...
							<ul class="desc_list" id="cardNotice">
								<li class="txt_puple">고속버스 탑승 시 결제에 사용된 카드(창구, 무인기 발권 시),
									모바일티켓, 홈티켓 중 하나를 가져오셔야 됩니다.</li>
								<li>예매가 완료된 후 예매확인/취소/변경 메뉴를 통해 예매내역을 확인 하시기 바랍니다.</li>
								<li>고속버스에 설치된 통합단말기에 기 결제한 카드(교통카드 기능이 있는 신용카드만 해당)를 태그하시면
									영수증과 승차권을 한번에 발권하실 수 있습니다.</li>
...
.box_inputForm.type3 ul {
	font-size: 12px
}

.box_inputForm.type3  ul li {
	list-style: disc;
	margin-left: 15px;
	padding-top: 5px;
}

.box_inputForm.type3  ul li::marker {
	color: red
}

.box_inputForm.type3 .custom_radio {
	width: auto;
	margin-right: 20px;
}

.box_inputForm.type3 .custom_radio img {
	height: 25px;
}

.box_inputForm.type3 .custom_radio input+label {
	padding-right: 0;
	padding-left: 17px;
}

.box_inputForm.type3 .custom_radio input:checked+label {
	background-position: left center
}

.box_inputForm.type3 .custom_radio input+label::after {
	content: "";
	width: 10px;
	height: 10px;
	...
	top: 7px;
							...
							<div class="box_inputForm">
								...
								<label for="bank">은행 선택 :</label> <select id="bank" name="bank">
							...
							<div class="box_inputForm type3 intxt">
								<div class="box_inputForm type3 white intxt">
									...
									<ul>
										<li>계좌이체 예매(또는 취소)단계에서 회선장애, 기타 통신장애 또는 예매 오류시에도 예매(취소)
											성공 여부를 꼭 확인하셔야 합니다.</li>
										<li>계좌이체 예매 후 승차권 터미널 발권 시 에는 예매당시 입력하신 휴대폰번호(회원의 경우 가입 시
											입력한 휴대폰번호)와 생년월일(법인은 사업자 등록번호)가 필요합니다.</li>
										<li>예매는 실패하였으나 출금이 되었을때는 1시간이내로 결제취소 후 다시 입금이 되고 해당좌석은 최소
											30분 후에 예매가능한 좌석이 됩니다.(경우에 따라 익일 아침에 입금 가능)</li>
										<li>계좌이체 예매취소시 즉시 예매당시의 출금계좌로 입금되나 장애 발생시 최대 한시간까지 입금이
											지연될 수도 있습니다.</li>
						...
						<!-- <div class="tab_conts" id="tab2" style="display: none;">
							...
							<div class="box_inputForm">
								...
								<label for="acBirth" id="acBirthLabel" class="label">생년월일
									...
									maxlength="6" onkeydown="this.value = onlyNumPlus(this.value);"
									onblur="fnChgCfmBtn();">
								</span>
							</div>
							...
							<div class="box_inputForm">
								<strong class="label">현금영수증 발급정보</strong> <span
									class="radio_wrap"> <span class="custom_radio2">
										<input type="radio" id="receiptPerson" name="receiptType"
										checked="true" value="Person"
										onclick="fnAcntCsrcInf2(&#39;Person&#39;)"> <label
										for="receiptPerson">개인소득공제용</label>
								</span> <span class="custom_radio2"> <input type="radio"
										id="receiptBusiness" name="receiptType" value="Business"
										onclick="fnAcntCsrcInf2(&#39;Business&#39;)"> <label
										for="receiptBusiness">사업자증빙용</label>
								</span> <span class="custom_radio2"> <input type="radio"
										id="receiptNone" name="receiptType" value=""
										onclick="fnAcntCsrcInf2(&#39;None&#39;)"> <label
										for="receiptNone">신청안함</label>
								</span>
								</span>
							</div>
							<div class="box_inputForm"
								...
								<div class="payment2">
									...
									<div class="dropdown-wrap select-default" id="acntCsrcPerson">
										<a href="javascript:void(0)" class="btn-dropdown"
											title="현금영수증 발급 방식 선택" aria-expanded="false"> <span
											class="text">휴대폰번호</span></a>
										<ul class="dropdown-list" style="display: none;">
											<li><a
												href="javascript:fnAcntCsrcInf(&#39;Person&#39;,&#39;receiptPhone&#39;)">휴대폰번호</a></li>
											<li><a
												href="javascript:fnAcntCsrcInf(&#39;Person&#39;,&#39;receiptCard&#39;)">현금영수증
													카드</a></li>
										</ul>
										<input type="hidden" name="receiptPersonSelect"
											id="receiptPersonSelect" value="receiptPhone">
									</div>
									...
									<div class="dropdown-wrap select-default"
										...
										<a href="javascript:void(0)" class="btn-dropdown"
											title="현금영수증 발급 방식 선택" aria-expanded="false"> <span
											class="text">사업자등록번호</span></a>
										<ul class="dropdown-list" style="display: none;">
											<li><a
												href="javascript:fnAcntCsrcInf(&#39;Business&#39;,&#39;receiptBizn&#39;)">사업자등록번호</a></li>
											<li><a
												href="javascript:fnAcntCsrcInf(&#39;Business&#39;,&#39;receiptCard&#39;)">현금영수증
													카드</a></li>
										</ul>
										<input type="hidden" name="receiptBusinessSelect"
											id="receiptBusinessSelect" value="receiptBizn">
									</div>
							...
							<div class="box_inputForm" id="acntCsrcMbph"
								...
								<label for="phoneNum2" class="label">휴대폰번호</label> <span
									class="box_label"> <input type="text" name=""
									id="phoneNum2" placeholder="(-)없이 입력" class="input"
									maxlength="11"
							...
							<div class="box_inputForm card_num clfix" id="acntCsrcCard"
								...
								<strong class="label">카드번호</strong> <span class="box_label">
									<input type="text" name="" id="reCardNum1" placeholder="입력"
									title="카드번호 첫 번째 4자리 입력" class="input" maxlength="4"
									onkeydown="this.value = onlyNumPlus(this.value);"
									onkeyup="fnChkNext(this,&#39;reCardNum2&#39;)">
								</span> <span class="box_label"> <input type="text" name=""
									id="reCardNum2" placeholder="입력" title="카드번호 두 번째 4자리 입력"
									class="input" maxlength="4"
									onkeydown="this.value = onlyNumPlus(this.value);"
									onkeyup="fnChkNext(this,&#39;reCardNum3&#39;)">
								</span> <span class="box_label"> <input type="password" name=""
									id="reCardNum3" placeholder="입력" title="카드번호 세 번째 4자리 입력"
									class="input" maxlength="4"
									onkeydown="this.value = onlyNumPlus(this.value);"
									onkeyup="fnChkNext(this,&#39;reCardNum4&#39;)">
								</span> <span class="box_label"> <input type="text" name=""
									id="reCardNum4" placeholder="입력" title="카드번호 네 번째 4자리 입력"
							...
							<div class="box_inputForm business_num clfix" id="acntCsrcBizn"
								...
								<strong class="label">사업자등록번호</strong> <span class="box_label">
									<input type="text" name="" id="reBiznNum1" placeholder="입력"
									title="사업자등록번호 첫 번째 3자리 입력" class="input" maxlength="3"
									onkeydown="this.value = onlyNumPlus(this.value);"
									onkeyup="fnChkNext(this,&#39;reBiznNum2&#39;)">
								</span> <span class="box_label"> <input type="text" name=""
									id="reBiznNum2" placeholder="입력" title="사업자등록번호 두 번째 2자리 입력"
									class="input" maxlength="2"
									onkeydown="this.value = onlyNumPlus(this.value);"
									onkeyup="fnChkNext(this,&#39;reBiznNum3&#39;)">
								</span> <span class="box_label"> <input type="text" name=""
									id="reBiznNum3" placeholder="입력" title="사업자등록번호 세 번째 5자리 입력"
						...
						<div class="tab_conts" id="tab3" style="display: none;">
							<div class="box_inputForm click_box inselect">
								<strong class="label"><span id="passBlank">정기권
										번호</span></strong>
								...
								<div class="dropdown-wrap select-default">
									<a href="javascript:void(0)" class="btn-dropdown"
										title="정기권 번호 선택" aria-expanded="false" id="perdNumList">
										<span class="text">선택</span>
									</a>
									<ul class="dropdown-list" id="perdAdtnPrdListLi"
										style="display: none;">
										<!-- <li><a href="javascript:void(0)">옵션1</a></li>
												<li><a href="javascript:void(0)">옵션2</a></li> -->
									</ul>
									<input type="hidden" name="perdAdtnPrdList"
										id="perdAdtnPrdList" value="">
								</div>

							</div>
							<!-- 181218 wrapper 추가 -->
							<div class="box_inputForm type2 white intxt">
								<strong>이용권종/이용가능일수/버스이용등급/사용일</strong>
								<!-- 191120 수정 -->
								<span class="box_label" id="perdAdtnPrdInfo">정기권 번호를
									선택해주세요.</span>
							</div>
						...
						<div class="tab_conts" id="tab4" style="display: none;">
							<div class="box_inputForm click_box inselect">
								...
								<div class="dropdown-wrap select-default">
									<a href="javascript:void(0)" class="btn-dropdown"
										title="프리패스 번호 선택" aria-expanded="false" id="frpsNumList">
										<span class="text">선택</span>
									</a>
									<ul class="dropdown-list" id="frpsAdtnPrdListLi"
										style="display: none;">
										<!-- <li><a href="javascript:void(0)">옵션1</a></li>
												<li><a href="javascript:void(0)">옵션2</a></li> -->
									</ul>
									<input type="hidden" name="frpsAdtnPrdList"
										id="frpsAdtnPrdList" value="">
								</div>
							...
							<!-- 181218 wrapper 추가 -->
							<div class="box_inputForm type2 white intxt">
								<strong>상품 종류/사용일/등급</strong> <span class="box_label"> <span
									class="useDate2" id="frpsAdtnPrdInfo">프리패스 번호를 선택해주세요.</span>
								</span>
							</div>
							<div class="box_inputForm type2 white intxt">
								<strong>사용일자</strong> <span class="box_label"> <span
									class="useDate2" id="frpsAdtnPrdExdt">사용기간 중에만 사용이
										가능합니다.</span>
								</span>
							</div>
						</div>
				...
				<div id="tab-desc1" class="section tab_desc_wrap">
					<!-- 190109 수정 : tab_desc_wrap 클래스 및 id 추가 -->
					<!-- 카드결제 -->
					...
					<!-- 계좌이체 -->
					<div class="tab_desc">
						<!-- 190109 추가 : wrapper 추가 - tab_desc -->

					</div>
					<div class="account_agreement agreement_wrap noiframe"
						id="acntNotice2" style="display: none;">
						<div class="agreement_tit">
							<h4>계좌이체 약관</h4>
						</div>
						<div class="scroll-wrapper agreement_cont scrollbar-inner"
							...
							<div class="agreement_cont scrollbar-inner scroll-content"
								...
								<ol>
									<li>1. 본 서비스의 이용과 관련하여 결제계좌 소유자의 정보는 “정보통신망이용촉진 및 정보보호등에
										관한 법률” ,“신용정보의 이용 및 보호에 관한 법률”규정에 따라 타인에게 제공 또는 활용시에는 결제계좌 소유자
										본인의 동의를 얻어야 하는 중요 정보임을 명백히 합니다.</li>
									<li>2. 인증확인서비스제공기관 및 제휴기관은 신청인 본인의 개인신용정보를 관계법령에 의해 철저히
										관리, 보관합니다.</li>
									<li>3.본 신청인은 예매내역의 확인과 서비스 이용을 위하여 결제계좌 소유자의 성명,주민번호 등 개인의
										정보를 당 서비스를 제공하는 업체(한국스마트카드)에 제공함으로써 원활한 서비스를 제공받는데 동의합니다.</li>
								</ol>
							</div>
							...
							<table>
								...
								<tbody>
									...
									<tr>
										...
										<td>
											<ul class="desc_list">
												<li>사용 시작 1일 전까지 취소 가능하며, 취소 시 전액(100%) 환불 됩니다.</li>
												<!-- 191118 수정 -->
											</ul>
										</td>
									</tr>
									<tr>
										...
										<td>
											...
											<p class="desc_add type02">※ 예시) 서울~천안/우등+심우 사용등급 정기권 금액
												304,200원 구매하고, 사용 기간 3일 경과 후 환불 시</p> <!-- 191118 수정 -->
											<ol>
					...
					<div class="tab_desc">
						<ul class="desc_list">
							<li><strong>터미널 창구 예매 시 필히 프리패스 번호와 신분증(생년월일 확인)을
									체출 하시기 바랍니다.</strong></li>
							<li>사용 기간 내 <span class="accent2">한번 사용한 노선은 해당 프리패스로
									재사용 불가합니다.</span></li>
							<li>명절 특송 기간에는 사용 불가 합니다.</li>
							<!-- 190319 수정 -->
							<li>사용가능 노선과 터미널를 꼭 확인하세요.</li>
							<!-- //190319 수정 -->
							...
							<li><span class="accent2">프리패스로 발권한 승차권은 해당 차량 출발전까지
									취소가 가능하나 해당 차량 출발 후에는 취소가 불가합니다.</span></li>
							<li>차량출발전 취소가 안된 경우 해당 노선은 프리패스를 이용한 승차권 재구매 불가합니다.</li>
							<li>차량출발전 취소를 못하고 해당 노선을 이용하고자 하시면 프리패스가 아닌 현금이나 카드로 승차권을
								구입하셔서 이용하셔야 합니다.</li>
						</ul>
					</div>
					<!-- // 프리패스 190109 추가 -->
					...
					<div class="tab_desc">
						<!-- 190109 추가 : wrapper 추가 - tab_desc -->
						<ul class="desc_list" id="milageNotice">
							<!-- 190109 수정 : display none 스타일 삭제 -->
		...
		<input type="hidden" id="hidfrmId" name="hidfrmId"
			value="stplCfmPymFrm"><input type="hidden"
			id="transkeyUuid_stplCfmPymFrm" name="transkeyUuid_stplCfmPymFrm"
			value="c3f09c69d4b7f6d31d840292f9c7d3daa0432b0d0ac3f5080c7d1e9ef9a4cee7"><input
			type="hidden" id="transkey_cardNum3_stplCfmPymFrm"
			name="transkey_cardNum3_stplCfmPymFrm" value=""><input
			type="hidden" id="transkey_HM_cardNum3_stplCfmPymFrm"
			name="transkey_HM_cardNum3_stplCfmPymFrm" value=""><input
			type="hidden" id="transkey_cardNum4_stplCfmPymFrm"
			name="transkey_cardNum4_stplCfmPymFrm" value=""><input
			type="hidden" id="transkey_HM_cardNum4_stplCfmPymFrm"
			name="transkey_HM_cardNum4_stplCfmPymFrm" value=""><input
			type="hidden" id="transkey_cardPw_stplCfmPymFrm"
			name="transkey_cardPw_stplCfmPymFrm" value=""><input
			type="hidden" id="transkey_HM_cardPw_stplCfmPymFrm"
			name="transkey_HM_cardPw_stplCfmPymFrm" value="">
	</form>
	<!-- 비회원 로그인을 위한 데이터 FORM -->
	<form name="nonMbrsLgnFrm" id="nonMbrsLgnFrm" method="post">
		<input type="hidden" name="returnUrl" id="returnUrl" value="">
		<!-- 리턴페이지 -->
		<input type="hidden" name="nombrsid" id="nombrsid" value="">
		<!-- 전화번호 -->
		<input type="hidden" name="nombrspass" id="nombrspass" value="">
		<!-- 인증번호 -->
	...
	<form name="payDtaFrm" id="payDtaFrm" method="post">
		...
		<input type="hidden" name="goodsName" id="payGoodsName"
			value="(고속버스티머니)승차권"> <input type="hidden" name="goodsCnt"
	...
	<form name="acntDtaFrm" id="acntDtaFrm" method="post">
		...
		<input type="hidden" name="amt" id="amt" value=""> <input
			type="hidden" name="buyerName" id="buyerName" value=""> <input
			type="hidden" name="buyerTel" id="buyerTel" value=""> <input
			type="hidden" name="moid" id="moid" value=""> <input
			type="hidden" name="mid" id="mid" value=""> <input
			type="hidden" name="userIP" id="userIP" value="">
		<!-- 회원사고객IP -->
		<input type="hidden" name="mallIP" id="mallIP" value="">
		<!-- 상점서버IP -->

		<!-- 옵션 -->
		<input type="hidden" name="vExp" id="vExp" value="">
		<!-- 가상계좌입금만료일 -->
		<input type="hidden" name="charSet" id="charSet" value="">
		<!-- 인코딩 설정 -->
		<input type="hidden" name="buyerEmail" id="buyerEmail" value="">
		<!-- 구매자 이메일 -->
		<input type="hidden" name="socketYN" id="socketYN" value="">
		<!-- 소켓이용유무 -->
		<input type="hidden" name="goodsCl" id="goodsCl" value="1">
		<!-- 상품구분(실물(1),컨텐츠(0)) -->
		<input type="hidden" name="transType" id="transType" value="0">
		<!-- 일반(0)/에스크로(1) -->

		<!-- 변경 불가능 -->
		<input type="hidden" name="encodeParameters" id="encodeParameters"
			value="">
		<!-- 암호화대상항목 -->
	...
	<form name="adtnPrdVldtFrm" id="adtnPrdVldtFrm" method="post">
		<!-- 부가상품 유효성 검사 -->
		<input type="hidden" name="adtnPrdDvsCdVldt" id="adtnPrdDvsCdVldt"
			value="">
		<!-- 부가상품 종류코드: 정액권, 정기권 확인필요   -->
		<input type="hidden" name="pubChtkSnoVldt" id="pubChtkSnoVldt"
			value="">
		<!-- 부가상품 일련번호   -->
		<input type="hidden" name="adtnAuthNo" id="adtnAuthNo" value="">
		<!-- 부가상품 인증번호   -->
		<input type="hidden" name="adtnDeprCd" id="adtnDeprCd" value="">
		<!-- 부가상품 출발지   -->
		<input type="hidden" name="adtnArvlCd" id="adtnArvlCd" value="">
		<!-- 부가상품 도착지   -->
		<input type="hidden" name="adtnSelSeatCnt" id="adtnSelSeatCnt"
			value="">
		<!-- 선택좌석수   -->
