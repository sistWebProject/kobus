...
<script src="${pageContext.request.contextPath}/resources/js/common/plugin.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/common/security.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/common/jquery.number.js"></script>
<script src="${pageContext.request.contextPath}/resources/js/kor/new-kor-ui.js"></script>
				...
				<form action="boardList.do" method="get" class="search_wrap type2">
					<div class="search_box">
						<input type="text" name="keyword" placeholder="검색어 입력"
							value="${keyword}">
						<button type="submit">
							<img src="${pageContext.request.contextPath}/resources/media/ico_search.png" alt="검색">
						</button>
					</div>
				</form>
				...
				<table>
					...
					<tbody>
						<c:forEach var="dto" items="${list}">
							<tr>
								<td>${dto.brdID}</td>
								<td class="title"><a href="view.do?brdID=${dto.brdID}">
										${dto.brdTitle}</a></td>
								<td>${dto.userId}</td>
