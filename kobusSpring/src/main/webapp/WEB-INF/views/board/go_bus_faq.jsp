...
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/media/renewal_kor.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/media/renewal_wchr.css">
<link rel="stylesheet" href="${pageContext.request.contextPath}/resources/media/content.css">
<script src="${pageContext.request.contextPath}/resources/media/jquery-1.12.4.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/media/jquery-ui.min.js"></script>
<script src="${pageContext.request.contextPath}/resources/media/jquery.jqGrid.min.js"></script>
<style>
.faq-section {
	width: 100%;
	max-width: 800px;
