...
<body>
	...
	<div class="com_info clfix">
		<p class="img">
			<img src="${pageContext.request.contextPath}/resources/media/lost_com6_s.png" alt="SAMHWA EXPRESS" class="hide_mo">
			<!-- 170227 수정 -->
			<img src="${pageContext.request.contextPath}/resources/media/lost_comL6.png" alt="SAMHWA EXPRESS" class="show_mo">
			<!-- 170227 수정 -->
		</p>
