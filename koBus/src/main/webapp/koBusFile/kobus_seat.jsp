<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<!DOCTYPE html>
<!-- saved from url=(0038)https://www.kobus.co.kr/mrs/satschc.do -->
...
<link rel="stylesheet" type="text/css"
	href="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/ui.jqgrid.custom.css">

<script type="text/javascript"
	src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/jquery-1.12.4.min.js.다운로드"></script>
<script type="text/javascript">
//쿠키 가져오기
...
<script type="text/javascript"
	src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/ui.js.다운로드"></script>
<script type="text/javascript"
	src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/plugin.js.다운로드"></script>
<script type="text/javascript"
	src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/common.js.다운로드"></script>

<script type="text/javascript"
	src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/jquery.number.js.다운로드"></script>
<script type="text/javascript"
	src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/security.js.다운로드"></script>


<link rel="stylesheet" type="text/css"
	href="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/style.css">
<script type="text/javascript"
	src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/new-kor-ui.js.다운로드"></script>
</head>
...
$(document).ready(function () {
				...
				<div class="container">
					<h1 id="logo">
						<a href="https://www.kobus.co.kr/main.do"> <img
							src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/logo.png"
				...
				<div class="container">
					...
					<i class="ico ico-arrow-new-window"></i>
						...
						<a href="https://www.kobus.co.kr/cscn/jobmttr/readJobList.do"
							...
							src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/ico-job-offer.png"
					...
					<div class="bg-layer">
						<a
							...
							title="새창" class="gnb-baaner"> <iframe
								src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/_ad-tubebox-002GNB.html"
	...
	console.log(feeList);
			...
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/SatsChc.js.다운로드"></script>

			<form name="satsChcFrm" id="satsChcFrm" method="post"
				action="https://www.kobus.co.kr/mrs/satschc.do">
				<input type="hidden" name="deprCd" id="deprCd" value="010">
				<!-- 출발지코드 -->
				<input type="hidden" name="deprNm" id="deprNm" value="서울경부">
				<!-- 출발지명 -->
				<input type="hidden" name="arvlCd" id="arvlCd" value="200">
				<!-- 도착지코드 -->
				<input type="hidden" name="arvlNm" id="arvlNm" value="강릉">
				<!-- 도착지명 -->
				...
				<!-- 버스등급 -->
				<input type="hidden" name="takeDrtmOrg" id="takeDrtmOrg" value="170">
				<!-- 소요시간 -->
				<input type="hidden" name="distOrg" id="distOrg" value="228.7">
				<!-- 거리 -->
			...
			<div class="content-header"
				...
				<div class="container">
					...
					<!-- 광고 배너 추후 추가 예정 -->
					<iframe
						src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/_ad-tubebox-002TITLE.html"
					...
					<div class="selectSeat_wrap">
						...
						<div class="compare_wrap">
							...
							<div class="infoBox">
								...
								<p class="date" id="satsDeprDtm">2025. 6. 21. 토</p>
								...
								<div class="route_wrap" id="satsRotInfo">
									<div class="inner">
										...
										<dl class="roundBox arrive kor">
											<dt>도착</dt>
											<dd id="satsArvlTmlNm">강릉</dd>
										</dl>
									</div>
									<div class="detail_info">
										<span id="satsTakeDrtm">2시간 50분 소요</span> <span id="satsDist">228.7
											Km</span>
									</div>
									<div class="btn_r">
									...
									<div class="selectSeat_box">
										<div class="bg_seatBox seat21" style="display: block;">
											<div class="bg_bus_img">
												<img
													src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/bg_bus21.png"
			...
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/ReadLgnInf.js.다운로드"></script>

			<!-- 20200617 yahan -->
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/transkey.js.다운로드"></script>
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/TranskeyLibPack_op.js.다운로드"></script>
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/rsa_oaep-min.js.다운로드"></script>
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/jsbn-min2.js.다운로드"></script>
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/typedarray.js.다운로드"></script>
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/transkeyServlet"></script>
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/transkeyServlet(1)"></script>
			<link rel="stylesheet" type="text/css"
				href="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/transkey.css">
			<script>
	$(function(){ initTranskey(); })
			...
			<!-- 20200831 yahan -->
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/transkey(1).js.다운로드"></script>
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/TranskeyLibPack_op.js.다운로드"></script>
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/rsa_oaep-min.js.다운로드"></script>
			...
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/typedarray.js.다운로드"></script>
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/transkeyServlet(2)"></script>
			<script type="text/javascript"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/transkeyServlet(1)"></script>
			<link rel="stylesheet" type="text/css"
				href="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/transkey.css">
...
// 	popRoute1.open();
				...
				<div class="footer-top-cont">
					<ul class="express-bus-company-list">
						<li><a href="http://www.kumhobuslines.co.kr/" target="_blank"
							title="새창"><img
								src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/logo-kumho-express.png"
								alt="금호고속"></a></li>
						<li><a href="http://www.dongbubus.com/" target="_blank"
							title="새창"><img
								src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/logo-dongbu-express.png"
								alt="동부고속"></a></li>
						<li><a href="http://www.songnisanbuslines.co.kr/"
							target="_blank" title="새창"><img
								src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/logo-sokrisan-express.png"
								alt="속리산고속"></a></li>
						<li><a href="http://www.dyexpress.co.kr/" target="_blank"
							title="새창"><img
								src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/logo-dongyang-express.png"
								alt="동양고속"></a></li>
						<li><a href="http://www.samhwaexpress.co.kr/" target="_blank"
							title="새창"><img
								src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/logo-samhwa-express.png"
								alt="삼화고속"></a></li>
						<li><a href="http://www.jabus.co.kr/" target="_blank"
							title="새창"><img
								src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/logo-joongang-express.png"
								alt="중앙고속"></a></li>
						<li><a href="http://www.chunilexpress.co.kr/" target="_blank"
							title="새창"><img
								src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/logo-chunil-express.png"
								alt="천일고속"></a></li>
						<li><a href="http://www.hanilexpress.co.kr/" target="_blank"
							title="새창"><img
								src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/logo-hanil-express.png"
								alt="한일고속"></a></li>
					</ul>
				...
				<div class="footer-bottom-cont">
					...
					<ul class="greeting-btn-list">
						<li><a
							...
							target="_blank" title="새창"><img
								src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/logo-accessibility2.png"
						...
						<li><a href="https://www.kobus.co.kr/ugd/bustrop/Bustrop.do"
							title="이사장 인사말 바로가기"><img
								src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/logo-kobus.png"
								alt="KOBUS 전국고속버스운송사업조합"></a></li>
						<li><a
							href="https://www.kobus.co.kr/ugd/trmlbizr/Trmlbizr.do"
							title="협회장 인사말 바로가기"><img
								src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/logo-npvtba-express.png"
	...
	<div class="remodal-wrapper remodal-is-closed" style="display: none;">
		<div class="remodal crew remodal-is-initialized remodal-is-closed"
			...
			<div class="cont">
				<img
					src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/img_crew_info1.jpg"
					alt="" class="crew_info">
				<div class="alt">
...
-->
	...
	<div class="remodal-wrapper remodal-is-closed" style="display: none;">
		<div class="remodal crew remodal-is-initialized remodal-is-closed"
			...
			<div class="cont">
				<img
					src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/img_crew_info2.jpg"
					alt="" class="crew_info">
...
-->
	...
	<div id="usrPwd_layout" class="transkey_divLayout">
		<div class="transkey_qwertyMainDiv" id="usrPwd_mainDiv"
			onmousemove="tk.showCursor(event,false);"
			onmouseout="tk.hideCursor(event);" onmouseover="tk.visibleCursor();">
			<div
				style="width: 560px; height: 28px; margin-left: 10px; margin-top: 2px;">
				<div id="usrPwd_dragDiv" class="transkey_qwertyDragDiv"
					onmousedown="tk.dragstart(event, this);"
					onmousewheel="tk.dragend(event);" onmouseup="tk.dragend(event);"></div>
			</div>
			<div class="transkey_div_2">
				<div class="transkey_div_2_2" onclick="tk.start(event,0);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,1);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,2);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,3);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,4);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,5);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,6);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,7);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,8);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,9);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,10);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,11);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,12);"
					role="button" tabindex="0"></div>
				<div id="tk_del" class="transkey_div_2_2"
					onclick="tk.start(event,61);" role="button" tabindex="0"></div>
			</div>
			<div class="transkey_div_2">
				<div class="transkey_div_2_2" onclick="tk.start(event,13);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,14);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,15);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,16);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,17);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_3" onclick="tk.start(event,18);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,19);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,20);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,21);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,22);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,23);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,24);"
					role="button" tabindex="0"></div>
			</div>
			<div class="transkey_div_2">
				<div class="transkey_div_2_2_2" style="margin-left: 40px;"
					onclick="tk.start(event,25);" role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,26);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,27);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,28);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_3" onclick="tk.start(event,29);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,30);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,31);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,32);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,33);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2_2" onclick="tk.start(event,34);"
					role="button" tabindex="0"></div>
			</div>
			<div class="transkey_div_2">
				<div id="tk_enter_l" class="transkey_q_l_enterKey"
					onclick="tk.start(event,60);" role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" style="margin-left: 80px;"
					onclick="tk.start(event,35);" role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,36);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,37);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,38);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,39);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,40);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,41);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,42);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,43);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,44);"
					role="button" tabindex="0"></div>
				<div id="tk_enter_r" class="transkey_q_r_enterKey"
					onclick="tk.start(event,59);" role="button" tabindex="0"></div>
			</div>
			<div class="transkey_div_2">
				<div id="tk_cp_l" class="transkey_div_2_2"
					onclick="tk.start(event,56);" role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,45);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,46);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,47);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,48);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,49);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_4" onclick="tk.start(event,50);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,51);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,52);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,53);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,54);"
					role="button" tabindex="0"></div>
				<div class="transkey_div_2_2" onclick="tk.start(event,55);"
					role="button" tabindex="0"></div>
				<div id="tk_cp_r" class="transkey_div_2_2"
					onclick="tk.start(event,57);" role="button" tabindex="0"></div>
			</div>
			<div class="transkey_div_2"
				style="position: absolute; top: -3px; right: 4px; width: 30px;">
				<div id="tk_close"
					style="position: absolute; width: 30px; height: 30px; right: 0;"
					onclick="tk.start(event,58);" role="button" tabindex="0"></div>
			</div>
		</div>
		<div id="usrPwd_layoutUpper" class="transkey_upper">
			<iframe id="usrPwd_block" title="가상키보드" frameborder="10"
				style="z-index: -1; position: absolute; visibility: hidden; left: 0px; top: 0px; width: 100%; height: 100%;"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/saved_resource.html"></iframe>
		</div>
		<div id="usrPwd_layoutLower" class="transkey_lower">
			<iframe id="usrPwd_block" title="가상키보드" frameborder="10"
				style="z-index: -1; position: absolute; visibility: hidden; left: 0px; top: 0px; width: 100%; height: 100%;"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/saved_resource(1).html"></iframe>
		</div>
		<div class="transkey_q_p_spacekey" id="usrPwdq_p_space">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_space.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_pKey" id="usrPwd_pKey">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/p_key.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_pKey" id="usrPwdq_p_backKey">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_backkey.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_pKey" id="usrPwdq_p_shiftkey_sp">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_shiftkey_sp.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_q_p_enterKey" id="usrPwdq_p_enterKey_L">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_enterkey_l.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_q_p_enterKey" id="usrPwdq_p_enterKey_R">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_enterkey_r.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_q_p_shiftKey" id="usrPwdq_p_shiftKey_L">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_shiftkey_l.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_q_p_shiftKey" id="usrPwdq_p_shiftKey_R">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_shiftkey_r.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div id="usrPwd_fakeMouseDiv" class="transkey_fakeMouse">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/fake.gif"
				id="fakeMouseImg">
		</div>
		<div id="usrPwd_osMouseDiv" class="transkey_osMouse">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/fake.gif"
				id="osMouseImg" onmousemove="tk.showCursor(event,true); onmouseout="
				tk.hidecursor(event);"="">
		</div>
		<div id="usrPwd_singleMouseTypeDiv"
			class="transkey_qwertySingleMouseType"
			onmousedown="tk.setMultiCursor(false);" role="button" tabindex="0"
			aria-label="기본마우스를 사용합니다.">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/single.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;" id="slngleMouseTypeImg">
		</div>
		<div id="usrPwd_blankOverDiv" class="transkey_qwertyBlankOver"
			onmouseover="tk.pauseKeyboard(false);"
			onclick="tk.pauseKeyboard(false);" tabindex="0"
			aria-label="마우스를 가운데로 이동 또는 클릭해주세요.">
			<img
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/blank_over.gif"
				alt="마우스이동" oncontextmenu="return false;"
				ondragstart="return false;" onselectstart="return false;"
				id="blankOverImg">
		</div>
		<div id="usrPwd_multiMouseTypeDiv"
			class="transkey_qwertyMultiMouseType"
			onclick="tk.setMultiCursor(true);" role="button"
			aria-label="멀티마우스를 사용합니다. 사용하시려면 키보드 클릭 후 마우스를 가운데로 이동 또는 클릭해주세요.">
			<img
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/multi.png"
				alt="멀티마우스" oncontextmenu="return false;"
				ondragstart="return false;" onselectstart="return false;"
				id="multiMouseTypeImg">
		</div>
		<div id="usrPwd_blankDiv" class="transkey_qwertyBlank">
			<img alt="TOUCH EN transkey"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/blank.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;" id="blankImg">
		</div>
	</div>
	<div id="usrOldPw_layout" class="transkey_divLayout">
		<div class="transkey_qwertyMainDiv" id="usrOldPw_mainDiv"
			onmousemove="tk.showCursor(event,false);"
			onmouseout="tk.hideCursor(event);" onmouseover="tk.visibleCursor();">
			<div
				style="width: 560px; height: 28px; margin-left: 10px; margin-top: 2px;">
				<div id="usrOldPw_dragDiv" class="transkey_qwertyDragDiv"
					onmousedown="tk.dragstart(event, this);"
					onmousewheel="tk.dragend(event);" onmouseup="tk.dragend(event);"></div>
			</div>
			<div class="transkey_div_2">
		...
		<div id="usrOldPw_layoutUpper" class="transkey_upper">
			<iframe id="usrOldPw_block" title="가상키보드" frameborder="10"
				style="z-index: -1; position: absolute; visibility: hidden; left: 0px; top: 0px; width: 100%; height: 100%;"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/saved_resource(2).html"></iframe>
		</div>
		<div id="usrOldPw_layoutLower" class="transkey_lower">
			<iframe id="usrOldPw_block" title="가상키보드" frameborder="10"
				style="z-index: -1; position: absolute; visibility: hidden; left: 0px; top: 0px; width: 100%; height: 100%;"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/saved_resource(3).html"></iframe>
		</div>
		<div class="transkey_q_p_spacekey" id="usrOldPwq_p_space">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_space.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_pKey" id="usrOldPw_pKey">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/p_key.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_pKey" id="usrOldPwq_p_backKey">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_backkey.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_pKey" id="usrOldPwq_p_shiftkey_sp">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_shiftkey_sp.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_q_p_enterKey" id="usrOldPwq_p_enterKey_L">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_enterkey_l.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_q_p_enterKey" id="usrOldPwq_p_enterKey_R">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_enterkey_r.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_q_p_shiftKey" id="usrOldPwq_p_shiftKey_L">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_shiftkey_l.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_q_p_shiftKey" id="usrOldPwq_p_shiftKey_R">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_shiftkey_r.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div id="usrOldPw_fakeMouseDiv" class="transkey_fakeMouse">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/fake.gif"
				id="fakeMouseImg">
		</div>
		<div id="usrOldPw_osMouseDiv" class="transkey_osMouse">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/fake.gif"
				id="osMouseImg" onmousemove="tk.showCursor(event,true); onmouseout="
				tk.hidecursor(event);"="">
		</div>
		<div id="usrOldPw_singleMouseTypeDiv"
			class="transkey_qwertySingleMouseType"
			onmousedown="tk.setMultiCursor(false);" role="button" tabindex="0"
			aria-label="기본마우스를 사용합니다.">
			<img alt=""
		...
		<div id="usrOldPw_blankOverDiv" class="transkey_qwertyBlankOver"
			onmouseover="tk.pauseKeyboard(false);"
			onclick="tk.pauseKeyboard(false);" tabindex="0"
			aria-label="마우스를 가운데로 이동 또는 클릭해주세요.">
			<img
		...
		<div id="usrOldPw_multiMouseTypeDiv"
			class="transkey_qwertyMultiMouseType"
			onclick="tk.setMultiCursor(true);" role="button"
			aria-label="멀티마우스를 사용합니다. 사용하시려면 키보드 클릭 후 마우스를 가운데로 이동 또는 클릭해주세요.">
			<img
		...
		<div id="usrOldPw_blankDiv" class="transkey_qwertyBlank">
			<img alt="TOUCH EN transkey"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/blank.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;" id="blankImg">
	...
	<div id="usrNewPwd_layout" class="transkey_divLayout">
		<div class="transkey_qwertyMainDiv" id="usrNewPwd_mainDiv"
			onmousemove="tk.showCursor(event,false);"
			onmouseout="tk.hideCursor(event);" onmouseover="tk.visibleCursor();">
			<div
				style="width: 560px; height: 28px; margin-left: 10px; margin-top: 2px;">
				<div id="usrNewPwd_dragDiv" class="transkey_qwertyDragDiv"
					onmousedown="tk.dragstart(event, this);"
					onmousewheel="tk.dragend(event);" onmouseup="tk.dragend(event);"></div>
			</div>
			<div class="transkey_div_2">
		...
		<div id="usrNewPwd_layoutUpper" class="transkey_upper">
			<iframe id="usrNewPwd_block" title="가상키보드" frameborder="10"
				style="z-index: -1; position: absolute; visibility: hidden; left: 0px; top: 0px; width: 100%; height: 100%;"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/saved_resource(4).html"></iframe>
		</div>
		<div id="usrNewPwd_layoutLower" class="transkey_lower">
			<iframe id="usrNewPwd_block" title="가상키보드" frameborder="10"
				style="z-index: -1; position: absolute; visibility: hidden; left: 0px; top: 0px; width: 100%; height: 100%;"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/saved_resource(5).html"></iframe>
		</div>
		<div class="transkey_q_p_spacekey" id="usrNewPwdq_p_space">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_space.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_pKey" id="usrNewPwd_pKey">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/p_key.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_pKey" id="usrNewPwdq_p_backKey">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_backkey.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_pKey" id="usrNewPwdq_p_shiftkey_sp">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_shiftkey_sp.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_q_p_enterKey" id="usrNewPwdq_p_enterKey_L">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_enterkey_l.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_q_p_enterKey" id="usrNewPwdq_p_enterKey_R">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_enterkey_r.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_q_p_shiftKey" id="usrNewPwdq_p_shiftKey_L">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_shiftkey_l.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div class="transkey_q_p_shiftKey" id="usrNewPwdq_p_shiftKey_R">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/q_p_shiftkey_r.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;">
		</div>
		<div id="usrNewPwd_fakeMouseDiv" class="transkey_fakeMouse">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/fake.gif"
				id="fakeMouseImg">
		</div>
		<div id="usrNewPwd_osMouseDiv" class="transkey_osMouse">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/fake.gif"
				id="osMouseImg" onmousemove="tk.showCursor(event,true); onmouseout="
				tk.hidecursor(event);"="">
		</div>
		<div id="usrNewPwd_singleMouseTypeDiv"
			class="transkey_qwertySingleMouseType"
			onmousedown="tk.setMultiCursor(false);" role="button" tabindex="0"
			aria-label="기본마우스를 사용합니다.">
			<img alt=""
		...
		<div id="usrNewPwd_blankOverDiv" class="transkey_qwertyBlankOver"
			onmouseover="tk.pauseKeyboard(false);"
			onclick="tk.pauseKeyboard(false);" tabindex="0"
			aria-label="마우스를 가운데로 이동 또는 클릭해주세요.">
			<img
		...
		<div id="usrNewPwd_multiMouseTypeDiv"
			class="transkey_qwertyMultiMouseType"
			onclick="tk.setMultiCursor(true);" role="button"
			aria-label="멀티마우스를 사용합니다. 사용하시려면 키보드 클릭 후 마우스를 가운데로 이동 또는 클릭해주세요.">
			<img
		...
		<div id="usrNewPwd_blankDiv" class="transkey_qwertyBlank">
			<img alt="TOUCH EN transkey"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/blank.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;" id="blankImg">
	...
	<div id="pwdCfmCheck_layout" class="transkey_divLayout">
		<div class="transkey_qwertyMainDiv" id="pwdCfmCheck_mainDiv"
			onmousemove="tk.showCursor(event,false);"
			onmouseout="tk.hideCursor(event);" onmouseover="tk.visibleCursor();">
			<div
				style="width: 560px; height: 28px; margin-left: 10px; margin-top: 2px;">
				<div id="pwdCfmCheck_dragDiv" class="transkey_qwertyDragDiv"
					onmousedown="tk.dragstart(event, this);"
					onmousewheel="tk.dragend(event);" onmouseup="tk.dragend(event);"></div>
			</div>
			<div class="transkey_div_2">
		...
		<div id="pwdCfmCheck_layoutUpper" class="transkey_upper">
			<iframe id="pwdCfmCheck_block" title="가상키보드" frameborder="10"
				style="z-index: -1; position: absolute; visibility: hidden; left: 0px; top: 0px; width: 100%; height: 100%;"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/saved_resource(6).html"></iframe>
		</div>
		<div id="pwdCfmCheck_layoutLower" class="transkey_lower">
			<iframe id="pwdCfmCheck_block" title="가상키보드" frameborder="10"
				style="z-index: -1; position: absolute; visibility: hidden; left: 0px; top: 0px; width: 100%; height: 100%;"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/saved_resource(7).html"></iframe>
		</div>
		...
		<div id="pwdCfmCheck_fakeMouseDiv" class="transkey_fakeMouse">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/fake.gif"
				id="fakeMouseImg">
		</div>
		<div id="pwdCfmCheck_osMouseDiv" class="transkey_osMouse">
			<img alt=""
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/fake.gif"
				id="osMouseImg" onmousemove="tk.showCursor(event,true); onmouseout="
				tk.hidecursor(event);"="">
		</div>
		<div id="pwdCfmCheck_singleMouseTypeDiv"
			class="transkey_qwertySingleMouseType"
			onmousedown="tk.setMultiCursor(false);" role="button" tabindex="0"
			aria-label="기본마우스를 사용합니다.">
			<img alt=""
		...
		<div id="pwdCfmCheck_blankOverDiv" class="transkey_qwertyBlankOver"
			onmouseover="tk.pauseKeyboard(false);"
			onclick="tk.pauseKeyboard(false);" tabindex="0"
			aria-label="마우스를 가운데로 이동 또는 클릭해주세요.">
			<img
		...
		<div id="pwdCfmCheck_multiMouseTypeDiv"
			class="transkey_qwertyMultiMouseType"
			onclick="tk.setMultiCursor(true);" role="button"
			aria-label="멀티마우스를 사용합니다. 사용하시려면 키보드 클릭 후 마우스를 가운데로 이동 또는 클릭해주세요.">
			<img
		...
		<div id="pwdCfmCheck_blankDiv" class="transkey_qwertyBlank">
			<img alt="TOUCH EN transkey"
				src="./예매정보입력(매수 및 좌석선택) _ 고속버스예매 _ 고속버스예매 _ 고속버스통합예매_files/blank.png"
				oncontextmenu="return false;" ondragstart="return false;"
				onselectstart="return false;" id="blankImg">
