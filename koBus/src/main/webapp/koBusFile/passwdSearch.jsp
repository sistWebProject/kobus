...
<body class="KO">
	...
	<div class="wrapper wrapper-kor wrapper-sub">
		...
		<nav id="new-kor-quickmenu">
			<ul class="quickmenu-list">
				...
				<li class="to-top"><a href="javascript:void(0)"> <span
						class="ico"><img alt=""
							src="/koBus/images/kor/layout/ico-to-top.png" /></span> <span
						class="text">TOP</span>
				</a></li>
			</ul>
		</nav>
		...
		<article id="new-kor-content">
			...
			<!-- 타이틀 -->
			<div class="content-header" data-page-title="비밀번호 찾기 | 고속버스통합예매">
				<div class="container">
			...
			<div class="content-body login_find">
				<div class="container">
					<form method="post" name="SrchPwdInqrFrm" onsubmit="return false;">
						<div class="noti_wrap">
								...
								<div class="find_input clfix">
									<div class="box_inputForm">
										<label class="label" for="usrId">아이디</label> <span
											...
											name="usrId" onchange="fnIcoCheck();" onkeyup="fnIcoCheck();"
											placeholder="아이디를 입력하세요" type="text" />
										</span>
									</div>
									<button class="btnL btn_confirm ready" id="btn_confirm"
										name="btn_confirm" onclick="srchIdCheck();" type="button">확인</button>
								</div>
							</div>
							<!-- 조회결과 -->
							<div class="find_result" id="findResult" style="display: none;">
								<div class="find_list">
									<p class="desc">회원정보에 등록되어 있는 휴대폰번호로 임시 비밀번호를 발송합니다.</p>
								</div>
							</div>
							<!-- // 조회결과 -->
						</div>
						<!-- 조회결과가 있을경우에만 노출 -->
						<p class="btns col1" id="btnsCol1" style="display: none;">
							<a class="btnL btn_confirm" href="javascript:tempPwdSend();">임시
								비밀번호 발송</a>
						</p>
						<!-- // 조회결과가 있을경우에만 노출 -->
					</form>
