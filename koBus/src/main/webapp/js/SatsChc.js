...
//	
//	if (feeList['2_a'] != undefined) dayDc += Number(chldCheckCnt)*(Number(feeList['2_0'])-Number(feeList['2_a']));
//	if (feeList['3_a'] != undefined) dayDc += Number(bohnCheckCnt)*(Number(feeList['3_0'])-Number(feeList['3_a']));
//	if (feeList['4_a'] != undefined) dayDc += Number(bohnCheckCnt)*(Number(feeList['4_0'])-Number(feeList['4_a']));
//	if (feeList['9_a'] != undefined) dayDc += Number(teenCheckCnt)*(Number(feeList['9_0'])-Number(feeList['9_a']));
//	if (feeList['8_a'] != undefined) dayDc += Number(uvsdCheckCnt)*(Number(feeList['8_0'])-Number(feeList['8_a']));
//	if (feeList['o_a'] != undefined) dayDc += Number(sncnCheckCnt)*(Number(feeList['o_0'])-Number(feeList['o_a']));
//	if (feeList['d_a'] != undefined) dayDc += Number(dsprCheckCnt)*(Number(feeList['d_0'])-Number(feeList['d_a']));
//	if (feeList['j_a'] != undefined) dayDc += Number(bohnCheckCnt)*(Number(feeList['j_0'])-Number(feeList['j_a']));
//	
//	if (feeList['2_b'] != undefined) holiDc += Number(chldCheckCnt)*(Number(feeList['2_0'])-Number(feeList['2_b']));
//	if (feeList['3_b'] != undefined) holiDc += Number(bohnCheckCnt)*(Number(feeList['3_0'])-Number(feeList['3_b']));
//	if (feeList['4_b'] != undefined) holiDc += Number(bohnCheckCnt)*(Number(feeList['4_0'])-Number(feeList['4_b']));
//	if (feeList['9_b'] != undefined) holiDc += Number(teenCheckCnt)*(Number(feeList['9_0'])-Number(feeList['9_b']));
//	if (feeList['8_b'] != undefined) holiDc += Number(uvsdCheckCnt)*(Number(feeList['8_0'])-Number(feeList['8_b']));
//	if (feeList['o_b'] != undefined) holiDc += Number(sncnCheckCnt)*(Number(feeList['o_0'])-Number(feeList['o_b']));
//	if (feeList['d_b'] != undefined) holiDc += Number(dsprCheckCnt)*(Number(feeList['d_0'])-Number(feeList['d_b']));
//	if (feeList['j_b'] != undefined) holiDc += Number(bohnCheckCnt)*(Number(feeList['j_0'])-Number(feeList['j_b']));
//	
//	
...
//		//adltUprc = 0;
//		if(Number($("#ctyDcFee2").val()) > 0 &&
//			$("input:checkbox[name=seatBoxDtl]:checked").length >= 5){
...
//			 * yahan
//			 */
//		if(Number($("#ctyDcFee5").val()) > 0 &&
//				$("input:checkbox[name=seatBoxDtl]:checked").length >= 4){
//				adltDcUprc = $("#ctyDcFee5").val();
//				$("#prmmDcDvsCd").val("5");
//		}else{
//			adltDcUprc = 0;
//		}
...
//		adltCheckDCCnt = $("#ctyDcFee3Cnt").val();
...
//		if (feeList['1_a'] != undefined) dayDc += Number(adltCheckCnt)*(Number(feeList['1_0'])-Number(feeList['1_a']));
//		if (feeList['2_a'] != undefined) dayDc += Number(chldCheckCnt)*(Number(feeList['2_0'])-Number(feeList['2_a']));
//		if (feeList['3_a'] != undefined) dayDc += Number(bohnCheckCnt)*(Number(feeList['3_0'])-Number(feeList['3_a']));
//		if (feeList['4_a'] != undefined) dayDc += Number(bohnCheckCnt)*(Number(feeList['4_0'])-Number(feeList['4_a']));
//		if (feeList['9_a'] != undefined) dayDc += Number(teenCheckCnt)*(Number(feeList['9_0'])-Number(feeList['9_a']));
...
//		if (feeList['1_b'] != undefined) holiDc += Number(adltCheckCnt)*(Number(feeList['1_0'])-Number(feeList['1_b']));
//		if (feeList['2_b'] != undefined) holiDc += Number(chldCheckCnt)*(Number(feeList['2_0'])-Number(feeList['2_b']));
//		if (feeList['3_b'] != undefined) holiDc += Number(bohnCheckCnt)*(Number(feeList['3_0'])-Number(feeList['3_b']));
//		if (feeList['4_b'] != undefined) holiDc += Number(bohnCheckCnt)*(Number(feeList['4_0'])-Number(feeList['4_b']));
//		if (feeList['9_b'] != undefined) holiDc += Number(teenCheckCnt)*(Number(feeList['9_0'])-Number(feeList['9_b']));
...
//	}
//	var dayMrsDc = 0, holiMrsDc = 0;
//	if (feeList['1_a'] != undefined) dayMrsDc += Number(adltCheckCnt)*(Number(feeList['1_0'])-Number(feeList['1_a']));
//	if (feeList['2_a'] != undefined) dayMrsDc += Number(chldCheckCnt)*(Number(feeList['2_0'])-Number(feeList['2_a']));
//	if (feeList['3_a'] != undefined) dayMrsDc += Number(bohnCheckCnt)*(Number(feeList['3_0'])-Number(feeList['3_a']));
//	if (feeList['4_a'] != undefined) dayMrsDc += Number(bohnCheckCnt)*(Number(feeList['4_0'])-Number(feeList['4_a']));
//	if (feeList['9_a'] != undefined) dayMrsDc += Number(teenCheckCnt)*(Number(feeList['9_0'])-Number(feeList['9_a']));
//	if (feeList['8_a'] != undefined) dayMrsDc += Number(uvsdCheckCnt)*(Number(feeList['8_0'])-Number(feeList['8_a']));
//	if (feeList['o_a'] != undefined) dayMrsDc += Number(sncnCheckCnt)*(Number(feeList['o_0'])-Number(feeList['o_a']));
//	if (feeList['d_a'] != undefined) dayMrsDc += Number(dsprCheckCnt)*(Number(feeList['d_0'])-Number(feeList['d_a']));
//	if (feeList['j_a'] != undefined) dayMrsDc += Number(bohnCheckCnt)*(Number(feeList['j_0'])-Number(feeList['j_a']));
//	
//	if (feeList['1_b'] != undefined) holiMrsDc += Number(adltCheckCnt)*(Number(feeList['1_0'])-Number(feeList['1_b']));
//	if (feeList['2_b'] != undefined) holiMrsDc += Number(chldCheckCnt)*(Number(feeList['2_0'])-Number(feeList['2_b']));
//	if (feeList['3_b'] != undefined) holiMrsDc += Number(bohnCheckCnt)*(Number(feeList['3_0'])-Number(feeList['3_b']));
//	if (feeList['4_b'] != undefined) holiMrsDc += Number(bohnCheckCnt)*(Number(feeList['4_0'])-Number(feeList['4_b']));
//	if (feeList['9_b'] != undefined) holiMrsDc += Number(teenCheckCnt)*(Number(feeList['9_0'])-Number(feeList['9_b']));
//	if (feeList['8_b'] != undefined) holiMrsDc += Number(uvsdCheckCnt)*(Number(feeList['8_0'])-Number(feeList['8_b']));
//	if (feeList['o_b'] != undefined) holiMrsDc += Number(sncnCheckCnt)*(Number(feeList['o_0'])-Number(feeList['o_b']));
//	if (feeList['d_b'] != undefined) holiMrsDc += Number(dsprCheckCnt)*(Number(feeList['d_0'])-Number(feeList['d_b']));
//	if (feeList['j_b'] != undefined) holiMrsDc += Number(bohnCheckCnt)*(Number(feeList['j_0'])-Number(feeList['j_b']));
//
//
//	/**
//	 * 20200724 yahan
...
//	//-----------------------------------------
//	// 선택한 할인을 적용한 실제 금액
//	var AllCllnDcUprc = ((Number(orgAdltCheckCnt)+Number(adltCheckDCCnt)) * Number(adltUprc))-
//						(Number(adltCheckDCCnt)*Number(adltDcUprc))+
//						chldCllnUprc+teenCllnUprc+uvsdCllnUprc+sncnCllnUprc+dsprCllnUprc+bohnCllnUprc
//						-dayDc-holiDc;
//			
